...
Я подумал, что для решения этой задачи наиболее подходящим инструментом будет SQL, который позволяет запрашивать данные с возможностью фильтрации и агррегации. А база данных вроде sqlite3 @sqlite3 или duckdb @duckdb, чтобы не занимало много места. Но в данном случае более наглядным решением, на мой взгляд, написать программу в виде интерактивного блокнота используя python @python, marimo @marimo и polars @polars.
